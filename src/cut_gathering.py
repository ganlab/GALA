...
import os
def cut_gathering(path,number_of_drafts,block=5000,percentage=70,shortage_contig=5000,quality=20,out_file=False,out_name='gathering',out_path=os.getcwd(),lowest_cut=1):
